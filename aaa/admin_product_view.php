                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="active item">
                                            ...
                                            <ul class="thumbnails">	
                                                ...
                                                <?php
                                              $qry="select * from seller,product,place where seller.userid=product.userid and seller.place_id=place.place_id";
$result=mysqli_query($con,$qry);
        ...
        Store:<?php echo $row['store_name'];?><br>
       Seller: <?php echo $row['first_name'];?><br>
       ...
       Selling Price: <img src="Indian_Rupee_symbol.png" height="9px" width="9px"><?php echo $row['selling_price'];?>
