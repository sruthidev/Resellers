                                    ...
                                    <div class="carousel-inner">
                                        ...
                                        <div class="active item">
                                            ...
                                            <ul class="thumbnails">	
                                                ...
                                                <?php
                                              $qry="select DISTINCT image,product_name,selling_price,book_id from booking,product where product.product_id=booking.product_id and booking.status3=1 and booking.status4=0 and booking.userid=$_SESSION[userid] GROUP BY product_name";
