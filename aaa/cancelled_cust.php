...
$qry="select DISTINCT image,product_name,selling_price from booking,product where booking.product_id=product.product_id and booking.status4=1 and booking.userid=$_SESSION[userid]";
