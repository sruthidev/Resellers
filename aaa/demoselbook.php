...
$qry="select * from booking,product,customer where product.product_id=booking.product_id and booking.status=1 and customer.userid=booking.userid and product.userid=$_SESSION[userid]";
