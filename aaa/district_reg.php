...
if (isset($_POST['signup'])) {
  ...
  // echo $category_select;
    ...
    if($row8['district_name']!=$subcategoryname){
   ...
   // if ($password1 == $password) {
        ...
        $sql1="INSERT INTO `district`( `district_name`,`state_id`,`status`) VALUES ('$subcategoryname',$category_select,1)";
        ...
        echo '<script> alert("RDistrict Added! ")</script>';
//    } else {
//
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				...
				<div class="row">
					...
					<div class="span12">					
                                            <center><h4 class="title"><span class="text"><strong>ADD DISTRICT</strong></span></h4></center>
...
<div class="form-group">
            <label class="col-md-4 control-label" for="street"> State</label>  
            <div class="col-md-4">
            ...
            <div class="col-md-4">
                <input id="subcategoryname" name="subcategoryname" type="text" placeholder="Enter district name" class="form-control input-md" required onChange="return fName()">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <!--<button class="btn btn-primary" id="btn_Product_reg" onclick="location.href = 'admin_add.php';" style="float: right;">BACK</button>-->
                                            ...
                                            <br>
<div class="span12">					
                                            <center><h4 class="title"><span class="text"><strong>ADDED DISTRICTS</strong></span></h4></center>
                                            <form >
...
?>
       ...
       <tr></tr>     <tr>
          <td></td>
          <td style="font-size: 20px;font-family: arial black;"><?php echo $row['district_name'];?></td>
