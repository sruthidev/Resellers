...
if (isset($_POST['signup'])) {
  ...
  // echo $category_select;
   ...
   // if ($password1 == $password) {
        ...
        $sql1="INSERT INTO `place`( `place_name`,`district_id`,`status`) VALUES ('$subcategoryname',$category_select,1)";
        
        $res = mysqli_query($con, $sql1)or die(mysqli_error($con));


        $p = "select max(place_id) as lgid from place";
...
//    }
     ...
     echo '<script> alert("Place Already Added! ")</script>';
}
    }
?>
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				...
				<div class="row">
					...
					<div class="span12">					
                                            <center><h4 class="title"><span class="text"><strong>ADD PLACE</strong></span></h4></center>
...
<div class="form-group">
            <label class="col-md-4 control-label" for="street"> District</label>  
            <div class="col-md-4">
                 
                        <select class="form-control" name="category_select" id="category_select">
                        <option value="-1">select</option> 
                     <?php
            $q = mysqli_query($con, "SELECT district_id,district_name FROM district where status=1");
            //var_dump($q);
            ...
            ?></select>
               ...
               <div class="form-group">
            <label class="col-md-4 control-label" for="name">Place</label>  
            <div class="col-md-4">
                <input id="subcategoryname" name="subcategoryname" type="text" placeholder="Enter Place Name" class="form-control input-md" required onChange="return fName()">
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <!--<button class="btn btn-primary" id="btn_Product_reg" onclick="location.href = 'admin_add.php';" style="float: right;">BACK</button>-->
                                            ...
                                            <br>
<div class="span12">					
                                            <center><h4 class="title"><span class="text"><strong>ADDED PLACES</strong></span></h4></center>
                                            <form >
...
?>
       ...
       <tr></tr>     <tr>
          <td></td>
          <td style="font-size: 20px;font-family: arial black;"><?php echo $row['place_name'];?></td>
