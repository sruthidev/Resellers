                                ...
                                <div id="myCarousel" class="myCarousel carousel slide">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="active item">
                                            <center><h4 class="title"><span class="text"><strong>PRODUCTS PAID</strong></span></h4></center>
                                            <ul class="thumbnails">	


                                                <?php
                                             $qry="select DISTINCT image,product_name,book_id,selling_price,first_name,mobile_number from booking,product,customer where product.product_id=booking.product_id and booking.status=1 and customer.userid=booking.userid and product.userid=$_SESSION[userid] GROUP BY product_name";
