                                ...
                                <div id="myCarousel" class="myCarousel carousel slide">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="active item">
                                            <center><h4 class="title"><span class="text"><strong>PRODUCTS SOLD</strong></span></h4></center>
                                            <ul class="thumbnails">	
...
//$qry="select DISTINCT image,product_name,selling_price from product,seller where seller.userid=product.userid and seller.place_id=$placeid and product.status1=1";
                    $qry="select DISTINCT image,product_name,selling_price from product where product.status1=1 and product.userid=$_SESSION[userid]";                             
