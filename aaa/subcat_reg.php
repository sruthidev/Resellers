...
if (isset($_POST['signup'])) {
  ...
  // echo $category_select;
    ...
    $sql4="select * from subcategory";
      $result1 = mysqli_query($con,$sql4);
    $row8 = mysqli_fetch_array($result1);
    if($row8['subcategory_name']!=$subcategoryname){
		...
		<div id="wrapper" class="container">
			...
			<img class="pageBanner" src="themes/images/pageBanner.png" alt="New products" >
				...
				<div class="row">
					...
					<div class="span12">					
                                            <center><h4 class="title"><span class="text"><strong>ADD SUBCATEGORY</strong></span></h4></center>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <!--<button class="btn btn-primary" id="btn_Product_reg" onclick="location.href = 'admin_add.php';" style="float: right;">BACK</button>-->
                                            ...
                                            <br>
<div class="span12">					
                                            <center><h4 class="title"><span class="text"><strong>ADDED SUBCATEGORIES</strong></span></h4></center>
                                            <form >
...
?>
       ...
       <tr></tr>     <tr>
          <td></td>
          <td style="font-size: 20px;font-family: arial black;"><?php echo $row['subcategory_name'];?></td>
