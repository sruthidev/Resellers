...
//echo $result8;
	...
	{
      echo "<script>if(confirm('This live cast channel is alreay sexist!!!')){document.location.href='AuctionSettings.php'}else{document.location.href='AuctionSettings.php'};</script>";
}	  
...
<div class="d2"><img src="<?php echo $img ?>" width="300px" height="200px" style=" border-radius:30px;margin-top:100px;">
</div>
...
<div class="d1">
       ...
       <table cellspacing="20" cellpadding="0" style="left:100px;margin-top:-250px;">
							...
							<tr>
                               <td>Date</td> <td><input type="date" name="auctiondate" style="border-color:white;" required></td>
                            </tr><br>
