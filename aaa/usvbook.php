                                ...
                                <div id="myCarousel" class="myCarousel carousel slide">
                                    <div class="carousel-inner">
                                        ...
                                        <div class="active item">
                                            <center><h4 class="title"><span class="text"><strong>PRODUCTS ORDERED</strong></span></h4></center>
                                            <ul class="thumbnails">	


                                                <?php
                                              $qry="select DISTINCT image,product_name,selling_price,book_id from booking,product where product.product_id=booking.product_id and booking.status=1 and booking.userid=$_SESSION[userid] GROUP BY product_name";
